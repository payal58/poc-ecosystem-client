...
export default function NewProgramPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      alert('Error creating program. Please check all required fields.')
    } finally {
      setLoading(false)
    }
  }
    ...
    <div className="min-h-screen bg-neutral-50 dark:bg-neutral-900">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-8">
        ...
        <div className="bg-white dark:bg-neutral-800 rounded-lg shadow-lg p-6 sm:p-8">
          <h1 className="text-2xl sm:text-3xl font-bold text-neutral-900 dark:text-white mb-6">Create New Program</h1>
